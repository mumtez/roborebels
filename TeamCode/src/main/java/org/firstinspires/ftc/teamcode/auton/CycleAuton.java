...
@Disabled
@Config
@Autonomous(name = "CYCLE AUTON")
public class CycleAuton extends LinearOpMode {

  public static int DRIVE_FORWARD = 130;
  public static int DRIVE_STRAFE = -550;
  public static int PARK_DIST = 2800;

  public static int PARK_DIST_2 = -500;
  ...
  public void runOpMode() throws InterruptedException {
    ...
    robot.turnByGyro(0);
    robot.encodeDriveStrafe(560, 0.5);

    robot.encodeDriveForward(30, 0.5);
    robot.turnByGyro(-45);
    ...
    robot.encodeDriveForward(-60, 0.5);
    robot.encodeDriveStrafe(-560, 0.5);
    robot.turnByGyro(-45);
    deposit();
