...
@Config
public class MotorEncoderTesting {
    ...
    public MotorEncoderTesting(LinearOpMode opMode, NewRobot robot) {
        this.opMode = opMode;
    ...
    public void updateTelemetry() {
        ...
        telemetry.addData("HSlide Encoder", robot.horSlide.hSlide.getCurrentPosition());

        telemetry.addData("SlideLeft Encoder", robot.slides.slideLeft.getCurrentPosition());
        telemetry.addData("SlideRight Encoder", robot.slides.slideRight.getCurrentPosition());
