...
public class PedroAuton extends OpMode{
    ...
    public void buildPaths() {
        ...
        path2 = follower.pathBuilder()
                .addPath(new BezierCurve(new Point(37.000, 65.000, Point.CARTESIAN), new Point(19.290, 29.159, Point.CARTESIAN), new Point(65.495, 33.869, Point.CARTESIAN)))
                .setLinearHeadingInterpolation(Math.toRadians(0), Math.toRadians(0))
                .build();

        path3 = follower.pathBuilder()
                .addPath(new BezierCurve(new Point(65.495, 33.869, Point.CARTESIAN), new Point(47.776, 22.654, Point.CARTESIAN), new Point(19.000, 23.000, Point.CARTESIAN)))
                .setLinearHeadingInterpolation(Math.toRadians(0), Math.toRadians(0))
                .build();
        ...
        path5 = follower.pathBuilder()
                .addPath(new BezierCurve(new Point(68.000, 23.000, Point.CARTESIAN), new Point(60.336, 15.252, Point.CARTESIAN), new Point(19.000, 19.065, Point.CARTESIAN)))
                .setLinearHeadingInterpolation(Math.toRadians(0), Math.toRadians(0))
                .build();
